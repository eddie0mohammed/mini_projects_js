...
// CONSTANTS
const API_KEY = '4bcea3a89ca1442ea765fca1509173cd';
const JOKE_API_URL = 'https://sv443.net/jokeapi/v2/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist&type=twoPart';
...
// get joke and pass it to speak on click
button.addEventListener('click', getJokes);
// re enable button when audio is done playing
